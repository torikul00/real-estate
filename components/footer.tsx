          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex">
                ...
                />
                <Button className="rounded-l-none bg-emerald-500 hover:bg-emerald-600">SignUp</Button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-navy-800 border-t border-gray-700 py-4">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center text-white">
            <p>
              © <span className="font-medium">Your Site Name</span>. All Right Reserved. Designed By{" "}
