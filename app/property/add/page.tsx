...
import { Upload, MapPin, DollarSign, Ruler, Bed, Bath, Loader2 } from "lucide-react"
...
export default function AddPropertyPage() {
   ...
   const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
         ...
         toast.loading("Submitting property...", { id: "property-submission" })
         ...
         formData.append('zipCode', (document.getElementById('zip') as HTMLInputElement).value)
         
         // Add property type and status
         formData.append('propertyType', propertyType)
         formData.append('status', listingType === 'sell' ? 'for-sale' : 'for-rent')
         
         // Add features
         formData.append('bedrooms', (document.getElementById('bedrooms') as HTMLInputElement).value)
         formData.append('bathrooms', (document.getElementById('bathrooms') as HTMLInputElement).value)
         formData.append('area', (document.getElementById('sqft') as HTMLInputElement).value)
         formData.append('parking', (document.getElementById('garage') as HTMLInputElement).value || '0')
         ...
         if (!response.ok) {
            toast.error(data.error || 'Failed to create property', { id: "property-submission" })
            return
         }
         
         toast.success('Property created successfully!', { id: "property-submission" })
         router.push('/properties')
         
      } catch (error) {
         console.error('Error submitting property:', error)
         toast.error(error instanceof Error ? error.message : 'Failed to create property', { id: "property-submission" })
      } finally {
                           ...
                           <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                              <div className="relative">
                                 <div className="absolute top-4 left-4 z-10">
                                    <span
                                       className={`px-3 py-1 text-sm font-medium text-white rounded-md ${listingType === "sell" ? "bg-emerald-500" : "bg-emerald-500"
                                          }`}
                                    >
